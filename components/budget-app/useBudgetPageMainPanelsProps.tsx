...
export function useBudgetPageMainPanelsProps(ctx: BudgetPageMainPanelsPropsContext): ComponentProps<typeof BudgetPageMainPanels> {
  ...
  return {
    ...
    financialGoalsContainerProps: {
          ...
          onSetGoalStatus: setFinancialGoalStatus,
    ...
    budgetLimitsPanelProps: {
          ...
          creatorRequest: budgetLimitCreatorRequest,
          onCreatorRequestHandled: () => setBudgetLimitCreatorRequest(null),
          onBackToBudget: () => setActiveUtilityPanel(null),
        },
    searchPanelProps: {
          ref: searchPanelRef,
    ...
    budgetTreeSectionProps: {
          ...
          onEditBudgetLimit: isBudgetLimitsModuleEnabled ? openBudgetLimitCreator : undefined,

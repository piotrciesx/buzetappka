...
const iconShapes: Record<UiIconKey, IconShape> = {
  ...
  child_3: { paths: ['M4.8 10.6a7.2 7.2 0 1 0 14.4 0 7.2 7.2 0 0 0-14.4 0Z', 'M12 3.9c-.8-1.9 1.9-3.1 3.8-1.5', 'M9.5 11.1h.01', 'M14.5 11.1h.01', 'M9.2 15.4c1.7 1.3 3.9 1.3 5.6 0'] },

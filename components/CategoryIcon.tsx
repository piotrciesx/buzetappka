...
const iconShapes: Record<UiIconKey, IconShape> = {
  ...
  note_1: { paths: ['M6 4.5h8.5l3.5 3.5v11.5H6z', 'M14.5 4.5V8h3.5', 'M8.5 11.5h7', 'M8.5 15h5'] },
  note_2: { paths: ['M6.5 4.5h8l3 3v12h-11z', 'M14.5 4.5v3h3', 'M8.7 12h6.6'] },
  note_3: { paths: ['M6.5 4.5h11v15h-11z', 'M9 12h6'] },
  note_4: { paths: ['M6.5 4.5h11v15h-11z', 'M9 10.5h6', 'M9 14h5'] },
  note_5: { paths: ['M7 4.5h10v15H7z', 'M9.2 4.5v15', 'M5.5 8h3', 'M5.5 12h3', 'M5.5 16h3'] },
  note_6: { paths: ['M7 5h10v14H7z', 'M9.5 8h5', 'M9.5 12h5', 'M9.5 16h3'] },
  note_7: { paths: ['M8 6h8v13H8z', 'M9.5 4.5h5L15.5 6h-7z', 'M10 10h4', 'M10 14h4'] },
  note_8: { paths: ['M6.5 4.5h11v15h-11z', 'M14 4.5v5l1.5-1 1.5 1', 'M9 12h4', 'M9 15h5'] },
  note_9: { paths: ['M5.5 6.5h6.5v12H5.5z', 'M12 6.5h6.5v12H12z', 'M8 10h2', 'M14 10h2'] },
  note_10: { paths: ['M6.5 5.5h11v13h-11z', 'M12 4.5v4', 'M9 12h6', 'M9 15h4'] },
  exchange: { paths: ['M7 7h10l-3-3', 'M17 17H7l3 3', 'M17 7l-3 3', 'M7 17l3-3'] },
  home: { paths: ['M4 11.5 12 5l8 6.5', 'M6.5 10v9h11v-9', 'M10 19v-5h4v5'] },
  home_1: { paths: ['M4 11.5 12 5l8 6.5', 'M6.5 10v9h11v-9', 'M10 19v-5h4v5'] },
  home_2: { paths: ['M4.5 11.5 12 5.5l7.5 6', 'M7 10.5V19h10v-8.5', 'M15 7.8V5h2v4.4', 'M10 19v-4.5h4V19'] },
  home_3: { paths: ['M5 12 12 6l7 6', 'M7.5 10.5V19h9v-8.5'] },
  home_4: { paths: ['M4.5 11.5 12 5l7.5 6.5', 'M7 10.8V19h10v-8.2', 'M10.5 19v-5h3V19'] },
  home_5: { paths: ['M4 12c2.5-2.8 5-5 8-7 3 2 5.5 4.2 8 7', 'M7 11v8h10v-8', 'M10 19v-4h4v4'] },
  home_6: { paths: ['M4.5 11.5 12 5l7.5 6.5', 'M7 10.5V19h10v-8.5', 'M10 15h4', 'M10 12h4'] },
  home_7: { paths: ['M5 11.5 12 5.5l7 6', 'M7 10.7V19h10v-8.3', 'M9.5 19v-5h5V19'] },
  home_8: { paths: ['M4.5 12.5 12 6l7.5 6.5', 'M6.5 12v7h11v-7', 'M9.5 19v-4.5h5V19'] },
  home_9: { paths: ['M4 11.5 12 5l8 6.5', 'M6.5 10.5v8.5h11v-8.5'] },
  home_10: { paths: ['M5 11.5 12 6l7 5.5', 'M7 12h10v7H7z'] },
  food: { paths: ['M7 4v16', 'M4.5 4v5a2.5 2.5 0 0 0 5 0V4', 'M16.5 4v16', 'M16.5 4c2 1.5 3 3.5 3 6v2h-3'] },
  food_1: { paths: ['M7 4v16', 'M4.5 4v5a2.5 2.5 0 0 0 5 0V4', 'M16.5 4v16', 'M16.5 4c2 1.5 3 3.5 3 6v2h-3'] },
  food_2: { paths: ['M7 4v16', 'M4.5 4v5a2.5 2.5 0 0 0 5 0V4', 'M16.5 4v16', 'M14 7a2.5 2.5 0 1 0 5 0 2.5 2.5 0 0 0-5 0'] },
  food_3: { paths: ['M12 5.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13Z', 'M7 4v7', 'M5.5 4v4a1.5 1.5 0 0 0 3 0V4'] },
  food_4: { paths: ['M7 10.5a3 3 0 0 1 5-3 3 3 0 0 1 5 3', 'M7 10.5h10v7H7z', 'M9 20h6'] },
  food_5: { paths: ['M6.5 13h11a4.5 4.5 0 0 1-4.5 5h-2A4.5 4.5 0 0 1 6.5 13Z', 'M8 10h8', 'M16 5l3 5', 'M13.5 5l3 5'] },
  food_6: { paths: ['M5.5 12a6.5 4.5 0 0 1 13 0', 'M5 12h14', 'M6.5 15h11', 'M7 18h10'] },
  food_7: { paths: ['M5 19 19 5 15.5 19z', 'M10 14h.01', 'M13 11h.01', 'M14 16h.01'] },
  food_8: { paths: ['M6 10h12v6a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4z', 'M8 10V7', 'M16 10V7', 'M7 7h10'] },
  food_9: { paths: ['M5.5 14h13', 'M7 14a5 5 0 0 1 10 0', 'M12 7.5V6', 'M6.5 18h11'] },
  food_10: { paths: ['M7 4v16', 'M4.5 4v5a2.5 2.5 0 0 0 5 0V4', 'M17.5 5 12 20', 'M19.5 6.5 14 20'] },
  shopping: { paths: ['M6.5 8.5h11l-1 11h-9z', 'M9 8.5a3 3 0 0 1 6 0'] },
  shopping_1: { paths: ['M6.5 8.5h11l-1 11h-9z', 'M9 8.5a3 3 0 0 1 6 0'] },
  shopping_2: { paths: ['M6.5 9h11l-1.2 10h-8.6z', 'M8 9l1-3h6l1 3', 'M9 13h6'] },
  shopping_3: { paths: ['M4 6h2l2 9h8.5l2-6H7', 'M9 19h.01', 'M16 19h.01'] },
  shopping_4: { paths: ['M6.5 9h11v10h-11z', 'M9 9a3 3 0 0 1 6 0'] },
  shopping_5: { paths: ['M7 8.5h10l-1 10H8z', 'M10 8.5a2 2 0 0 1 4 0'] },
  shopping_6: { paths: ['M7 7.5h10v12H7z', 'M9.5 7.5V5.5h5v2'] },
  shopping_7: { paths: ['M6.5 8.5h11v11h-11z', 'M9.5 8.5a2.5 2.5 0 0 1 5 0', 'M9 12h6'] },
  shopping_8: { paths: ['M4.5 6.5h2l1.8 8.5h8.2l2-6.2H7.2', 'M9.2 18.5h.01', 'M16 18.5h.01'] },
  shopping_9: { paths: ['M6.5 10h11l-1 8.5h-9z', 'M8.5 10 12 6l3.5 4'] },
  shopping_10: { paths: ['M6.5 8.5h11l-1 11h-9z', 'M9 8.5a3 3 0 0 1 6 0', 'M12 12v4', 'M10 14h4'] },

...
const iconShapes: Record<UiIconKey, IconShape> = {
  ...
  idea: { paths: ['M9 10a3 3 0 1 1 6 0c0 1.35-.7 2.15-1.45 2.9-.55.55-1.05 1.05-1.05 2.1h-1c0-1.05-.5-1.55-1.05-2.1C9.7 12.15 9 11.35 9 10Z', 'M10 17h4', 'M10.5 19.5h3'] },

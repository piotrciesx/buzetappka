...
const iconShapes: Record<UiIconKey, IconShape> = {
  ...
  warning: { paths: ['M8.5 10a3.5 3.5 0 1 1 7 0c0 1.55-.85 2.45-1.75 3.25-.55.5-1 1-1 1.75h-1.5c0-.75-.45-1.25-1-1.75-.9-.8-1.75-1.7-1.75-3.25Z', 'M10.25 17h3.5'] },
  idea: { paths: ['M8 10a4 4 0 1 1 8 0c0 1.65-.9 2.65-1.8 3.45-.6.55-1.1 1.05-1.1 1.55h-2.2c0-.5-.5-1-1.1-1.55C8.9 12.65 8 11.65 8 10Z', 'M10.25 17h3.5'] },
  heart: { paths: ['M8.5 10.2a3.5 3.5 0 1 1 7 0c0 1.45-.8 2.3-1.65 3.1-.55.5-.95.95-1.1 1.7h-1.5c-.15-.75-.55-1.2-1.1-1.7-.85-.8-1.65-1.65-1.65-3.1Z', 'M10.2 17h3.6', 'M11 19.3h2'] },
  calendar: { paths: ['M9 10a3 3 0 1 1 6 0c0 1.45-.75 2.25-1.5 3-.55.55-1 1-1 2h-1c0-1-.45-1.45-1-2-.75-.75-1.5-1.55-1.5-3Z', 'M10.5 17h3'] },

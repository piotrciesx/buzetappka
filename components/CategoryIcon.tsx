...
const iconShapes: Record<UiIconKey, IconShape> = {
  ...
  car_2: { paths: ['M3.8 15h1.7l1.45-3.35A2.2 2.2 0 0 1 9 10.3h6a2.2 2.2 0 0 1 2.05 1.35L18.5 15h1.7', 'M6.2 15h11.6', 'M8.1 18.3h.01', 'M15.9 18.3h.01', 'M8.6 12.4h6.8'] },
  car_3: { paths: ['M4 15.2h16', 'M6.7 15.2l1.5-3.4h7.6l1.5 3.4', 'M8.1 18.2h.01', 'M15.9 18.2h.01', 'M9 12.2h6'] },
  car_4: { paths: ['M4.2 15.1h1.5l1.1-3.1a2.1 2.1 0 0 1 2-1.4h6.4a2.1 2.1 0 0 1 2 1.4l1.1 3.1h1.5', 'M6.5 15.1h11', 'M8.2 18.3h.01', 'M15.8 18.3h.01', 'M8.7 12.6h6.6'] },
  car_5: { paths: ['M3.8 15.4h16.4', 'M6.2 15.4l1.6-3.8h8.4l1.6 3.8', 'M8 18.4h.01', 'M16 18.4h.01', 'M9 12.1h6'] },
  car_6: { paths: ['M4.2 15h1.4l1.7-3.7a2.25 2.25 0 0 1 2.05-1.3h5.3a2.25 2.25 0 0 1 2.05 1.3L18.4 15h1.4', 'M6.3 15h11.4', 'M8.2 18.2h.01', 'M15.8 18.2h.01', 'M8.8 12h6.4'] },
  car_7: { paths: ['M4 14.9h1.6l1-2.8a2.25 2.25 0 0 1 2.1-1.5h7.1a2.25 2.25 0 0 1 2.1 1.5l1 2.8H20', 'M6.4 14.9h11.2', 'M8.3 18.1h.01', 'M15.7 18.1h.01', 'M8.7 12.6h7.1'] },
  car_8: { paths: ['M3.8 15.2h2l1.25-3.15a2.15 2.15 0 0 1 2-1.35h5.9a2.15 2.15 0 0 1 2 1.35l1.25 3.15h2', 'M6.5 15.2h11', 'M8.2 18.4h.01', 'M15.8 18.4h.01', 'M9.1 12.5h5.8'] },
  car_9: { paths: ['M4.1 15h1.3l1.45-3.2a2.1 2.1 0 0 1 1.9-1.25h6.5a2.1 2.1 0 0 1 1.9 1.25L18.6 15h1.3', 'M6.4 15h11.2', 'M8.1 18.25h.01', 'M15.9 18.25h.01', 'M8.9 12.45h6.2'] },
  car_10: { paths: ['M4 15.3h16', 'M6.5 15.3l1.35-3.2a2 2 0 0 1 1.85-1.25h4.6a2 2 0 0 1 1.85 1.25l1.35 3.2', 'M8.2 18.3h.01', 'M15.8 18.3h.01', 'M9.2 12.6h5.6'] },
  ...
  plane_2: { paths: ['M3.5 13.5 20.5 6.5', 'M20.5 6.5l-4.7 11-3.7-4-4.9 2.3 2.4-4.4z'] },
  plane_3: { paths: ['M4 15.5 20 8.2', 'M20 8.2l-2.9 8.3-4.1-3.1-3.7 4.1-1.4-.9 3-5.2-5.7-2.2z'] },
  plane_4: { paths: ['M4.2 16.2 19.8 7.2', 'M19.8 7.2l-1.9 8.9-4.5-3.4-3.2 4.5-1.7-1 2.8-5.6-6.1-2.4z'] },
  plane_5: { paths: ['M3.8 13.2 20.2 6.8', 'M20.2 6.8l-5.2 10.7-3.2-4.1-5.3 2.2 2.7-4.3z'] },
  plane_6: { paths: ['M4 12.5 20 5.5', 'M20 5.5l-5.8 14-3.1-5.5-5.7 2.4 3-4.8z'] },
  plane_7: { paths: ['M4.2 16.8 19.8 6.8', 'M19.8 6.8l-1 9.2-5-3.2-3.4 4.9-1.5-.9 2.6-5.7-6-1.8z'] },
  plane_8: { paths: ['M4.5 14.8 19.5 7.5', 'M19.5 7.5l-2.5 8.7-4.1-3.5-3.8 4.3-1.5-1 3-5.4-5.4-2.1z'] },
  plane_9: { paths: ['M3.8 15.9 20.2 7.1', 'M20.2 7.1l-2.8 8.8-4.2-3.2-3.7 4.4-1.5-1 2.9-5.4-6-2.2z'] },
  plane_10: { paths: ['M4.1 12.9 19.9 6.4', 'M19.9 6.4l-4.8 11.2-3.6-4.2-5.1 2.1 2.8-4.2z'] },
  ...
  health_2: { paths: ['M12 20s-7-4.5-7-10a4 4 0 0 1 7-2.6A4 4 0 0 1 19 10c0 5.5-7 10-7 10Z', 'M12 9v5', 'M9.5 11.5h5'] },
  health_3: { paths: ['M6 11h4V7h4v4h4v4h-4v4h-4v-4H6z'] },
  health_4: { paths: ['M5 12h4l2-5 3 10 2-5h3', 'M12 20s-7-4.2-7-9.5a4 4 0 0 1 7-2.7 4 4 0 0 1 7 2.7'] },
  health_5: { paths: ['M5.5 9.5h13v10h-13z', 'M8.5 9.5V7a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v2.5', 'M12 12v5', 'M9.5 14.5h5'] },
  health_6: { paths: ['M8 5h8v14H8z', 'M12 8v8', 'M9 12h6', 'M7 19h10'] },
  health_7: { paths: ['M6 12h3.5l1.7-4.5 3 9 1.5-4.5H18', 'M4.5 12a7.5 7.5 0 0 1 15 0'] },
  health_8: { paths: ['M12 20s-6.5-4.2-6.5-9.5a3.8 3.8 0 0 1 6.5-2.7 3.8 3.8 0 0 1 6.5 2.7C18.5 15.8 12 20 12 20Z', 'M9.5 12h5'] },
  health_9: { paths: ['M5.5 10.5h13v8.5h-13z', 'M9 10.5V7.5h6v3', 'M12 13v3.5', 'M10.2 14.8h3.6'] },
  health_10: { paths: ['M12 4.5a5.5 5.5 0 0 0-5.5 5.5c0 5 5.5 9.5 5.5 9.5s5.5-4.5 5.5-9.5A5.5 5.5 0 0 0 12 4.5Z', 'M12 8v5', 'M9.5 10.5h5'] },
  ...
  fuel_2: { paths: ['M6.5 4.5h8.5v16h-8.5z', 'M8.7 8.2h4.1', 'M15 8.5l3.8 3.8v4.9a1.8 1.8 0 0 1-3.6 0v-2.7h2'] },
  fuel_3: { paths: ['M7 4.5h8v16H7z', 'M9 8.5h4', 'M15 10h1.2l2.8 2.8v4a2 2 0 0 1-4 0v-2'] },
  fuel_4: { paths: ['M6 20.5h9.5', 'M7 4.5h7.5v16H7z', 'M8.7 8.3h4.1', 'M14.5 9l4 4v4.2a1.7 1.7 0 0 1-3.4 0v-2.7h1.8'] },
  fuel_5: { paths: ['M6.5 4.5h8.5v16h-8.5z', 'M8.5 8.5h4.5', 'M15 9.2l3.5 3.5', 'M18.5 12.7v4.3a1.9 1.9 0 0 1-3.8 0v-2.5'] },
  fuel_6: { paths: ['M7 5h8v15H7z', 'M9 8.5h4', 'M15 9.5h1.3l2.2 2.2v5.5a1.8 1.8 0 0 1-3.6 0v-2.7h2'] },
  fuel_7: { paths: ['M6.5 20h9', 'M7 5h8v15H7z', 'M8.8 8.8h4.4', 'M15 9l4 4v3.8a2 2 0 0 1-4 0v-2.3h2'] },
  fuel_8: { paths: ['M6.8 4.8h7.8v15.4H6.8z', 'M8.7 8.4h4', 'M14.6 9l3.9 4v4a1.85 1.85 0 0 1-3.7 0v-2.4h1.8'] },
  fuel_9: { paths: ['M6.5 4.5h8.5v16h-8.5z', 'M8.5 8.5h4.5', 'M15 9l3.7 3.7v4.6a1.8 1.8 0 0 1-3.6 0v-2.8h2'] },
  fuel_10: { paths: ['M7 4.5h8v16H7z', 'M8.8 8.2h4.4', 'M15 9.5l3.5 3.5v4.1a1.9 1.9 0 0 1-3.8 0v-2.6h1.8'] },

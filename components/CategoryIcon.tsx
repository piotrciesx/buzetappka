...
const iconShapes: Record<UiIconKey, IconShape> = {
  ...
  warning: { paths: ['M6.9 9.1a5.1 5.1 0 1 1 10.2 0c0 2.05-1.1 3.1-2.2 4.05-.75.65-1.35 1.15-1.35 1.75h-3.1c0-.6-.6-1.1-1.35-1.75-1.1-.95-2.2-2-2.2-4.05Z', 'M11.2 17.2h1.6'] },
  idea: { paths: ['M6.9 9.1a5.1 5.1 0 1 1 10.2 0c0 2.05-1.1 3.1-2.2 4.05-.75.65-1.35 1.15-1.35 1.75h-3.1c0-.6-.6-1.1-1.35-1.75-1.1-.95-2.2-2-2.2-4.05Z', 'M11.5 17.2h1'] },
  heart: { paths: ['M6.4 9.2a5.6 5.6 0 1 1 11.2 0c0 2.25-1.2 3.45-2.45 4.5-.8.7-1.45 1.25-1.45 2.15h-3.4c0-.9-.65-1.45-1.45-2.15C7.6 12.65 6.4 11.45 6.4 9.2Z', 'M9.1 18.1h5.8'] },
  calendar: { paths: ['M6.9 9.1a5.1 5.1 0 1 1 10.2 0c0 2.05-1.1 3.1-2.2 4.05-.75.65-1.35 1.15-1.35 1.75h-3.1c0-.6-.6-1.1-1.35-1.75-1.1-.95-2.2-2-2.2-4.05Z', 'M10.9 17.2h2.2'] },

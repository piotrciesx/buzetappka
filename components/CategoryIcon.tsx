...
const iconShapes: Record<UiIconKey, IconShape> = {
  ...
  car_2: { paths: ['M3.5 15h1.8l1.4-3.5A2.25 2.25 0 0 1 8.8 10h6.5a2.25 2.25 0 0 1 2.05 1.35L18.8 15h1.7', 'M6.3 15h11.4', 'M8 18.4h.01', 'M16 18.4h.01', 'M8.4 12.2h7.2'] },
  car_3: { paths: ['M4 15.2h1.7l1.1-3a2 2 0 0 1 1.9-1.3h5.9a2 2 0 0 1 1.8 1.1l1.7 3.2H20', 'M6.5 15.2h11', 'M8 18.3h.01', 'M16 18.3h.01', 'M9 12.5h6.4'] },
  car_4: { paths: ['M3.8 15.3h2l1.3-2.9a2.1 2.1 0 0 1 1.9-1.2h6a2.1 2.1 0 0 1 1.9 1.2l1.3 2.9h2', 'M6.4 15.3h11.2', 'M8.2 18.3h.01', 'M15.8 18.3h.01', 'M8.8 12.8h6.4'] },
  car_5: { paths: ['M3.5 15.4h1.8l1.5-3.3a2.4 2.4 0 0 1 2.2-1.4h6.7a2 2 0 0 1 1.8 1.1l1.6 3.6h1.4', 'M6.3 15.4h11.8', 'M8 18.4h.01', 'M16.2 18.4h.01', 'M8.7 12.5h7.4'] },
  car_6: { paths: ['M4.5 15h1.4l1.1-3a2 2 0 0 1 1.9-1.3h5.2A2 2 0 0 1 16 12l2.1 3H20', 'M6.5 15h11', 'M8.2 18.2h.01', 'M15.8 18.2h.01', 'M9.2 12.5h5.5'] },
  car_7: { paths: ['M3.5 15h1.8l1.7-3.6A2.4 2.4 0 0 1 9.2 10h5.7a2.4 2.4 0 0 1 2.15 1.3L18.9 15h1.6', 'M6.2 15h11.6', 'M8 18.5h.01', 'M16 18.5h.01', 'M8.5 12h7'] },
  car_8: { paths: ['M4 15h2l1.4-3h9.2l1.4 3h2', 'M6 15h12', 'M8.5 18.5h.01', 'M15.5 18.5h.01'] },
  car_9: { paths: ['M4 15h1.5l1-3.2a2 2 0 0 1 1.9-1.4h7.8a2 2 0 0 1 2 2V15H20', 'M6.3 15h11.5', 'M8.3 18.4h.01', 'M16.3 18.4h.01', 'M8.5 12.4h7.8'] },
  car_10: { paths: ['M4 14.8h16', 'M6.5 14.8l1.5-3.4h7.8l1.7 3.4', 'M8 18.2h.01', 'M16 18.2h.01'] },
  ...
  transport_3: { paths: ['M6.5 5.5h11A1.5 1.5 0 0 1 19 7v10.5H5V7a1.5 1.5 0 0 1 1.5-1.5Z', 'M7.5 9h9', 'M7.5 13h9', 'M8.5 20h.01', 'M15.5 20h.01', 'M9 3.5h6'] },
  ...
  plane_2: { paths: ['M3.8 16.8 20.2 7.2', 'M20.2 7.2l-2.4 8.8-4.4-3.5-3.5 4.4-1.8-1 3-5.5-6.1-2.5z'] },
  plane_3: { paths: ['M4 15.8 20 8', 'M20 8l-2 8-4.5-3-3.2 4.4-1.5-.8 2.6-5.2-5.6-2.2z'] },
  plane_4: { paths: ['M4.5 17 19.5 6.8', 'M19.5 6.8l-1.2 8.5-4.7-3-3 4.4-1.4-.8 2.3-5.4-5.5-1.7z'] },
  plane_5: { paths: ['M5 18 18.5 5.5', 'M18.5 5.5l-.2 8.2-4.2-2.6-3.8 4.2-1.2-1 3-5-5.4-2z'] },
  plane_6: { paths: ['M4 16 20 8', 'M20 8 12 19l-1-6-6-2z'] },
  plane_7: { paths: ['M4 12 20 5 14 20l-3.2-6.2z', 'M20 5 10.8 13.8'] },
  plane_8: { paths: ['M3.5 16.5 20.5 7.5', 'M20.5 7.5 17 17l-4.2-3.9-4 4.9-1.6-1.1 3.5-5.7-6.4-2.4z'] },
  plane_9: { paths: ['M4 16.3 20 7.7', 'M20 7.7l-2.6 8.5-4-3.2-3.5 4.2-1.4-.9 2.8-5.2-5.9-2.2z'] },
  plane_10: { paths: ['M3.8 17 20.2 7', 'M20.2 7l-1.5 8.8-4.8-3.5-3.6 4.7-1.7-.9 2.8-5.6-6.3-2.1z'] },
  ...
  coffee_2: { paths: ['M6 9h10v5.5a4 4 0 0 1-4 4h-2a4 4 0 0 1-4-4z', 'M16 10h1a3 3 0 0 1 0 6h-1'] },
  coffee_3: { paths: ['M5.5 9h10.5v5a4 4 0 0 1-4 4h-2.5a4 4 0 0 1-4-4z', 'M16 10h1a2.8 2.8 0 0 1 0 5.6h-1', 'M7 19.5h10'] },
  coffee_4: { paths: ['M8 4.5h8v14H8z', 'M10 7h4', 'M16 8h1a2.5 2.5 0 0 1 0 5h-1', 'M10 20h4'] },
  coffee_5: { paths: ['M5.5 9h11v5.5a4 4 0 0 1-4 4h-3a4 4 0 0 1-4-4z', 'M16.5 10h1a3 3 0 0 1 0 6h-1', 'M8 5v1', 'M12 5v1', 'M15 5v1'] },
  coffee_6: { paths: ['M8 12c0-4 3-7 8-7 1.5 5-1.5 10-6 10-1.2 0-2-.8-2-3Z', 'M8 12c2 0 4-2 6-5'] },
  coffee_7: { paths: ['M6.5 10h9v4a3.5 3.5 0 0 1-3.5 3.5h-2a3.5 3.5 0 0 1-3.5-3.5z', 'M15.5 11h1a2.2 2.2 0 0 1 0 4.4h-1'] },
  coffee_8: { paths: ['M5.5 9h11v5.5a4 4 0 0 1-4 4h-3a4 4 0 0 1-4-4z', 'M16.5 10h1a3 3 0 0 1 0 6h-1', 'M12 15s-2-1.2-2-2.5a1.2 1.2 0 0 1 2-.8 1.2 1.2 0 0 1 2 .8c0 1.3-2 2.5-2 2.5Z'] },

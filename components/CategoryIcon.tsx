...
const iconShapes: Record<UiIconKey, IconShape> = {
  ...
  car: { paths: ['M4 15.5h1.4l1.4-3.8a2 2 0 0 1 1.9-1.2h6.6a2 2 0 0 1 1.9 1.2l1.4 3.8H20', 'M6.5 15.5h11', 'M8 18.5h.01', 'M16 18.5h.01', 'M7.8 12.5h8.4', 'M9 10.5l-1.2 2', 'M15 10.5l1.2 2'] },
  transport: { paths: ['M7 5.5h10a2 2 0 0 1 2 2v9.5H5V7.5a2 2 0 0 1 2-2Z', 'M7.5 9h9', 'M7.5 13h9', 'M8.5 20h.01', 'M15.5 20h.01'] },

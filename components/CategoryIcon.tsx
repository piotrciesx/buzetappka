...
const iconShapes: Record<UiIconKey, IconShape> = {
  ...
  warning: { paths: ['M7.5 9.6a4.5 4.5 0 1 1 9 0c0 1.9-1 2.9-2 3.75-.65.55-1.2 1.05-1.2 1.85h-2.6c0-.8-.55-1.3-1.2-1.85-1-.85-2-1.85-2-3.75Z', 'M9.8 17.4h4.4'] },
  idea: { paths: ['M7 9.4a5 5 0 1 1 10 0c0 2.05-1.1 3.15-2.2 4.1-.7.6-1.3 1.15-1.3 2h-3c0-.85-.6-1.4-1.3-2C8.1 12.55 7 11.45 7 9.4Z', 'M9.5 17.7h5'] },
  ...
  calendar: { paths: ['M8 9.7a4 4 0 1 1 8 0c0 1.7-.9 2.65-1.8 3.45-.6.55-1.1 1.05-1.1 1.85h-2.2c0-.8-.5-1.3-1.1-1.85C8.9 12.35 8 11.4 8 9.7Z', 'M10.2 17h3.6'] },

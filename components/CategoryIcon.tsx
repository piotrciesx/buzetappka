...
const iconShapes: Record<UiIconKey, IconShape> = {
  ...
  plane_2: { paths: ['M12 3.2c.7 0 1.15.5 1.15 1.2v5.65l6.35 3.2c.35.2.55.55.55.95v1.25l-6.9-1.9v3.8l2.55 1.55v1.15L12 19.2l-3.7.85V18.9l2.55-1.55v-3.8l-6.9 1.9V14.2c0-.4.2-.75.55-.95l6.35-3.2V4.4c0-.7.45-1.2 1.15-1.2Z'] },
  plane_3: { paths: ['M4.2 16.4 19.8 7.6', 'M19.8 7.6l-2.2 8.6-4.4-3.1-3.8 4.5-1.7-.95 3-5.4-6.2-2.1z'] },
  plane_4: { paths: ['M3.7 13.1h7.15l3.9-6.3h2.45l-2.1 6.3h4.1c.9 0 1.6.7 1.6 1.6s-.7 1.6-1.6 1.6h-4.1l2.1 6.3h-2.45l-3.9-6.3H3.7l2.1-1.6z'] },
  plane_5: { paths: ['M12 2.8c.75 0 1.2.55 1.2 1.3v5.9l6.45 3.35c.38.2.6.58.6 1.02v1.28l-7.05-1.95v3.9l2.55 1.6v1.15L12 19.45l-3.75.9V19.2l2.55-1.6v-3.9l-7.05 1.95v-1.28c0-.44.22-.82.6-1.02L10.8 10V4.1c0-.75.45-1.3 1.2-1.3Z'] },
  plane_6: { paths: ['M4.5 15.9 19.5 8.1', 'M19.5 8.1l-1.9 8.35-4.7-3.2-3.55 4.7-1.65-.9 2.75-5.6-6.25-2.05z'] },

...
export const budgetPageStyles: Record<string, CSSProperties> = {
  ...
  input: {
    height: uiControlPrimitives.input.m.height,
    padding: uiControlPrimitives.input.m.padding,
    borderRadius: uiControlPrimitives.input.m.radius,
    border: uiControlPrimitives.input.m.border,
    background: uiControlPrimitives.input.m.background,
    color: uiControlPrimitives.input.m.color,
    fontSize: uiControlPrimitives.input.m.fontSize,
    minWidth: 180,
    maxWidth: '100%',
    boxSizing: 'border-box',
    outline: uiControlPrimitives.input.m.outline,
  } as const,

  smallInput: {
    height: uiControlPrimitives.input.s.height,
    padding: uiControlPrimitives.input.s.padding,
    borderRadius: uiControlPrimitives.input.s.radius,
    border: uiControlPrimitives.input.s.border,
    background: uiControlPrimitives.input.s.background,
    color: uiControlPrimitives.input.s.color,
    fontSize: uiControlPrimitives.input.s.fontSize,
    width: 120,
    maxWidth: '100%',
    boxSizing: 'border-box',
    outline: uiControlPrimitives.input.s.outline,
  } as const,

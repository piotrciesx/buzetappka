...
export const APP_ICON_ALIASES: Record<UiIconKey, string[]> = {
  note: ['notatka', 'notatki', 'tekst', 'opis'],
  exchange: ['wymiana', 'zamiana', 'przeniesienie'],
  home: ['dom', 'mieszkanie'],
  food: ['jedzenie', 'restauracja', 'widelec', 'nóż', 'obiad', 'kolacja'],
  shopping: ['zakupy', 'koszyk', 'sklep'],
  basket: ['koszyk', 'zakupy', 'sklep'],
  car: ['auto', 'samochód'],
  transport: ['transport', 'komunikacja', 'tramwaj', 'autobus'],
  plane: ['samolot', 'lot', 'loty', 'podróż', 'podróże', 'wakacje', 'urlop', 'wyjazd', 'wyjazdy'],
  holiday: ['wakacje', 'urlop', 'podróż', 'samolot'],
  sun: ['słońce', 'pogoda', 'jasne'],
  health: ['zdrowie', 'medyczne'],
  doctor: ['lekarz', 'doktor', 'medyczne'],
  pharmacy: ['apteka', 'leki', 'farmacja', 'lekarz'],
  work: ['praca', 'firma'],
  salary: ['pensja', 'wypłata', 'portfel', 'wynagrodzenie'],
  bills: ['rachunki', 'paragon', 'faktura', 'opłaty'],
  bill: ['paragon', 'rachunki', 'faktura'],
  electricity: ['prąd', 'energia'],
  internet: ['internet', 'wifi', 'sieć'],
  phone: ['telefon', 'smartfon'],
  education: ['edukacja', 'szkoła', 'studia'],
  books: ['książki', 'czytanie'],
  sport: ['sport', 'piłka'],
  gym: ['siłownia', 'sztanga', 'trening'],
  gaming: ['gaming', 'komputer', 'gry'],
  entertainment: ['rozrywka', 'kino', 'film'],
  cinema: ['kino', 'film', 'telewizja'],
  gift: ['prezent', 'upominek'],
  clothes: ['ubrania', 'odzież'],
  pets: ['zwierzęta', 'pies', 'kot', 'łapka'],
  child: ['dziecko', 'dzieci'],
  savings: ['oszczędności', 'konto', 'bank'],
  cash: ['gotówka', 'pieniądze', 'banknot'],
  card: ['karta', 'płatność'],
  bank: ['bank', 'oszczędności', 'konto', 'konto oszczędnościowe', 'lokata'],
  investments: ['inwestycje', 'wzrost', 'zysk', 'giełda'],
  restaurant: ['restauracja', 'jedzenie', 'widelec', 'nóż'],
  coffee: ['kawa', 'napój'],
  fuel: ['paliwo', 'benzyna'],
  travel: ['podróż', 'podróże', 'wakacje', 'urlop', 'samolot'],
  warning: ['ważne', 'uwaga', 'alert'],
  idea: ['pomysł', 'idea', 'żarówka'],
  heart: ['osobiste', 'serce'],
  calendar: ['kalendarz', 'termin', 'data'],
  more: ['pozostałe', 'inne', 'nieskończoność'],
  plus: ['dodaj', 'plus'],
  edit: ['edytuj', 'zmień'],
  trash: ['usuń', 'kosz'],
  close: ['zamknij', 'x'],
  expand: ['rozwiń', 'więcej'],
  info: ['informacja', 'info'],
}

export const getUiIconSearchText = (icon: { key: UiIconKey; label: string }) =>
  [icon.label, icon.key, ...(APP_ICON_ALIASES[icon.key] || [])].join(' ').toLowerCase()
